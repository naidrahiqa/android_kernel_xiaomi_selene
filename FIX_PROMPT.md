...
- ReSukiSU: main @ `25d94deb` (KSU_VERSION 35097), source at `resukisu/kernel/`, symlink at `drivers/kernelsu`
...
- Kbuild fallback version pin: `KSU_LOCAL_VERSION := 4397`, tag `v4.2.0-rc1`, sha `25d94deb` — jangan set ke 1 (manager tidak deteksi root)
