...
- ReSukiSU: `v4.2.0-rc2` @ `5cfdd725` (KSU_VERSION 35160), source at `resukisu/kernel/`, symlink at `drivers/kernelsu`
...
- Kbuild fallback version pin: `KSU_LOCAL_VERSION := 4460`, tag `v4.2.0-rc2`, sha `5cfdd725` — jangan set ke 1 (manager tidak deteksi root)
