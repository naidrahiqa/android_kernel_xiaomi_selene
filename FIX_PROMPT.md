...
- ReSukiSU: `v4.2.0-rc2` @ `3576e6a525` (KSU_VERSION 35144), source at `resukisu/kernel/`, symlink at `drivers/kernelsu`
...
- Kbuild fallback version pin: `KSU_LOCAL_VERSION := 4444`, tag `v4.2.0-rc2`, sha `3576e6a525` — jangan set ke 1 (manager tidak deteksi root)
