...
- ReSukiSU: main @ `0b5efe9e01` (KSU_VERSION 35114), source at `resukisu/kernel/`, symlink at `drivers/kernelsu`
...
- Kbuild fallback version pin: `KSU_LOCAL_VERSION := 4414`, tag `v4.2.0-rc1`, sha `0b5efe9e01` — jangan set ke 1 (manager tidak deteksi root)
