...
- ReSukiSU: main @ `83614d892d` (KSU_VERSION 35104), source at `resukisu/kernel/`, symlink at `drivers/kernelsu`
...
- Kbuild fallback version pin: `KSU_LOCAL_VERSION := 4404`, tag `v4.2.0-rc1`, sha `83614d892d` — jangan set ke 1 (manager tidak deteksi root)
