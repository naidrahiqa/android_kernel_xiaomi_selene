...
/*
 * NoMount - Systemless Path Redirection VFS Subsystem
 * Source: https://github.com/maxsteeel/nomount (v20)
 * Ported to Linux 4.14 for Phrolova selene kernel
 *
 * Architecture: dentry/inode/superblock operation hijacking + keyring control
 */
